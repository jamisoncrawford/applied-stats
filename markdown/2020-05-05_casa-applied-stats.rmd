...
author: "Center for the Advancement of Students & Alumni"
...
Welcome to *Visualizing Statistics*, a part of the Summer 2020 workshop series 
for the [Center for the Advancement of Students & Alumni (CASA)](https://casa.gsu.edu/). 
...
This week, you'll learn about fundamental concepts in data science, statistics, 
and analytics, as well as how to visualize your findings using spreadsheet 
software like *Microsoft Excel* and *Google Sheets*.  

<br>

Not every career makes heavy use of these concepts and tools, but basic data 
literacy is critical for most careers, as well as the various ways we consume 
data, statistics, and visualizations in our daily lives.
...
Throughout this workshop, you'll practice analyzing and visualizing data the 
breadth of vocabulary of various hip hop artists, as well as the most 
influential hip hop tracks of all time.  You can learn more in these sources:
...
2. Different kinds of data and how they are formatted

3. Basic statistics for summarizing and reporting data
...
He is an Institutional Research Associate at Georgia State University's 
Graduate School and Center for the Advancement of Students & Alumni (CASA), as 
well as a Faculty Associate at Georgia State's Andrew Young School, where he 
teaches *Coding in R*, and a Faculty Associate at Arizona State University's 
Watts College, where he teaches *Foundations of Data Science*. 

<br>

Jamison has been been designing instructional material and teaching adult learners 
for nearly ten years. He earned his graduate degree in Public Administration at 
...
interpreting quantitative information - or information related to quantities.  
...
knitr::include_graphics("ex_sports.jpg")
...
knitr::include_graphics("ex_finance.jpg")
...
knitr::include_graphics("ex_utility.jpg")
...
knitr::include_graphics("ex_fitness.jpg")
...
knitr::include_graphics("ex_politics.jpg")
...
knitr::include_graphics("ex_travel.jpg")
...
knitr::include_graphics("ex_games.jpg")
...
knitr::include_graphics("ex_weather.jpg")
...
knitr::include_graphics("ex_nature.jpg")
...
knitr::include_graphics("ex_music.jpg")
...
Now that you've had an opportunity to see data "in the wild", it's easier to 
understand just how common data, statistics, and visualizations are in our daily 
lives.  Where else do you see data in your life and how has it enabled you to 
learn and make decisions?

<br>

We'll harness much of the power of data, statistics, and visualizations and learn 
how to communicate big ideas with evidence and visual communication, as well as 
how to consume and interpret these ideas from others.

<br>

Again, your future career(s) may not involve analyzing or reporting data, but it 
most certainly will involve interpreting data presented by others.
...
1. What do you think the author meant with these "categories"?

2. How might this workshop help in confronting these and other "lies"?

3. Four books' titles allude to this quote (see below) - why?

    a. "Damned Lies and Statistics: Untangling Numbers from the Media, Politicians, and Activists"
    
    b. "Lies, Damned Lies, and Statistics: The Manipulation of Public Opinion in America"
    
    c. "Quotes, Damned Quotes... Some of Them to Do with Statistics"
...
knitr::include_graphics("ch1_pemdas.jpg")
...
knitr::include_graphics("ch1_tv-formula.jpg")
...
It's so nice that you'll decide your next apartment based on it's ability to 
accommodate your TV. 
...
knitr::include_graphics("ch1_tablet.jpg")
...
knitr::include_graphics("ch1_rows.jpg")
...
knitr::include_graphics("ch1_columns.jpg")
...
knitr::include_graphics("ch1_chess.png")
...
knitr::include_graphics("ch1_diagram.jpg")
...
But it's probably still funner than math, so let's try it out.

<br>

```{r fig.align = "center", out.width = "75%"}

knitr::include_graphics("ch1_battleship.jpg")
...
*Source: [HiLoBrow](https://www.hilobrow.com/2019/01/10/planet-of-peril-35/)*

</center>

<br>

**Instructions:** Observe the following board layout 
(from [Wikipedia](https://en.wikipedia.org/wiki/Battleship_(game))) and select 
the correct choice.
...
knitr::include_graphics("ch1_board.jpg")

```

<br>

1. Which cell is a direct hit on one of the smallest battleships?
    a. `F6`
    b. `J3`
    c. `A8`
    d. All of the above
    
2. Which cell is a direct hit on the largest battleship?
    a. `I9`
    b. `D2`
    c. `J10`
    d. All of the above
    
3. Which range of cells will sink an entire battleship?
    a. `C1:E1`
    b. `F6:F7`
    c. `C10:F10`
    d. All of the above
...
**Challenge:** Provide the range of cells that sinks the largest battleship. 
...
knitr::include_graphics("ch1_dilbert1.jpg")
...
knitr::include_graphics("ch1_excel.jpg")
...
knitr::include_graphics("ch1_sheets.jpg")
...
knitr::include_graphics("ch1_cell.jpg")
...
cells are combined with a colon, `:`.  For example:
...
knitr::include_graphics("ch1_range.jpg")
...
knitr::include_graphics("ch1_formula.jpg")
...
knitr::include_graphics("ch1_formula2.jpg")
...
knitr::include_graphics("ch1_handle.jpg")
...
knitr::include_graphics("ch1_range-gif.gif")
...
knitr::include_graphics("ch1_xkcd1.png")
...
knitr::include_graphics("ch1_function-gif.gif")
...
**Instructions:** So far, we've been using the first 15 hip hop artists from the 
...
*Note: The unique word count of each hip hop artist is based on the first 35,000*
*words out of all of their lyrics.*

In column `C`, create a new formula that divides column `B` by 35,000. It should
look like this:
...
3. What is the proportional difference between Immortal Technique's and Aesop 
Rock's vocabulary?

<br>

**Challenge:** After finding the proportions of each artist's unique lyrics, use 
...
knitr::include_graphics("ch2_quan-qual.jpg")
...
It is possible to transform **qualitative** data into **quantitative** data, and 
the reverse is also true.  It does not necessarily alter the data, but it allows 
us to derive new variables from existing data. 

<br>

For example, we can turn **quantitative** data into ranges or categories based on 
their numeric values.  This is called **discretization**, because we take numbers 
on a continuous scale and slice them into new ranges or categories. 
...
knitr::include_graphics("ch2_discrete.jpg")
...
For example, we can use function `LEN()` to tally the number of letters and 
spaces in each artist's name - that is, the "length" (`LEN()`) of a text value.

<br>

```{r fig.align = "center", out.width = "50%"}

knitr::include_graphics("ch2_length.jpg")
...
Data comes in a wide variety of **classes**.  The framework for 
naming them is not universal across spreadsheet software or programming languages, 
...
* For example, tallies of individual students are typically **integer**, since you 
...
knitr::include_graphics("ch2_integer.jpg")
...
knitr::include_graphics("ch2_dates.jpg")
...
Data **types** are more important in determining statistical methods of analysis, 
rather than data visualization, and are most often used to further classify 
**qualitative** variables (i.e. **text** or **character** data). 
...
**Discrete** data are comprised of **numeric** values that are whole, indivisible, 
and most notably, countable. 

In our hip hop data, we can clearly *count* the number of unique words, but there
are no partial words.  Snoop Dogg has 3,974 unique words - not 3,974.3 unique words.
...
**Continuous** data are comprised of **numeric** values that may or may not be 
whole numbers, exist along a spectrum, and are divisible into smaller values. 

When you calculated the proportion of artists' unique words out of 35,000, you
*measured*, rather than *counted* this number.  

For example, when comparing Dirty South rappers, 13.7314 % of Ludacris' first 
35,000 lyrics were unique, whereas André 3000 and Big Bi of Outlast have 
a slightly more varied vocabulary with 14.8914 % unique words. These proportions 
are **continuous**.
...
**Categorical**, also called **nominal** data are values which may be defined as 
categories.  
...
knitr::include_graphics("ch2_categories.jpg")
...
One **categorical** variable might be "Era" or "Decade". That is, when did the 
artist emerge?
...
knitr::include_graphics("ch2_eras.jpg")
...
**Non-ordinal** categories, for example, may include sub genres of *Dirty South* 
hip hop:

* [Snap](https://en.wikipedia.org/wiki/Snap_music) (Atlanta, GA)

* [Trap](https://en.wikipedia.org/wiki/Trap_music) (Atlanta, GA)

* [Bounce](https://en.wikipedia.org/wiki/Bounce_music) (New Orleans, LA)

* [Trunk](https://en.wikipedia.org/wiki/Trunk) (Memphis, TN)

* [Chopped & Screwed](https://en.wikipedia.org/wiki/Chopped_and_screwed) (Houston, TX)

* [Booty Bass](https://en.wikipedia.org/wiki/Miami_bass) (Miami, FL)
...
1. Socioeconomic Status: "Low Income", "Middle Income", "High Income"
    ...
    b. Continuous
    c. Categorical
    d. Non-Ordinal Categorical

<br>

2. Continent: "Africa", "Asia", "Antarctica", "Australia", "Europe", "N. America", "S. America"
    a. Discrete
    b. Continuous
...
3. Educational Attainment: "High School", "Bachelors", "Masters/JD", "PhD/MD"
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
4. Eye Color: "Amber", "Blue", "Brown", "Hazel", "Green" 
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
5. Boston Marathon Times: "03:08:21", "03:23:48", "03:33: 18", etc.
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
7. Likert Scale Options: "Strongly Disagree", "Agree", "Neutral", "Agree", "Strongly Agree"
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
8. Enrolled Students: "0", "1", "2", "3", "4", "5", ... etc.
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
9. NBA Games Played (GP): "0", "1", "2", ... etc.
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
10. Free Throw Percentage (FT%): "72.0 %", "80.3 %", "75.9 %", "90.2 %"
    a. Discrete
    b. Continuous
    c. Ordinal Categorical
    d. Non-Ordinal Categorical
...
knitr::include_graphics("ch2_zips.jpg")
...
knitr::include_graphics("ch2_zips2.jpg")
...
knitr::include_graphics("ch2_highlight.gif")
...
knitr::include_graphics("ch2_excel-format.gif")
...
knitr::include_graphics("ch2_sheets-format.gif")
...
knitr::include_graphics("ch2_excel-shortcuts.gif")
...
knitr::include_graphics("ch2_sheets-shortcuts.gif")
...
3. Convert variable `Wu-Tang` to binary, or "0" for `FALSE` and "1" for `TRUE`
    ...
    a. **Note:** *I'm not sure why all Wu-Tang members aren't here - is The Pudding not down with ODB?* 

    b. This must be performed manually with a "Find & Replace":
...
Simply reporting data does not make it an analysis. It requires some degree of 
*summarization*.
...
knitr::include_graphics("ch3_workflow.jpg")
...
knitr::include_graphics("ch3_5numsum.png")
...
knitr::include_graphics("ch3_average.gif")
...
knitr::include_graphics("ch3_minmax.gif")
...
knitr::include_graphics("ch3_median.gif")
...
knitr::include_graphics("ch3_quartile.gif")
...
knitr::include_graphics("ch3_shortcuts.gif")
...
knitr::include_graphics("ch3_sheets-shortcuts.gif")
...
knitr::include_graphics("ch4_otherviz.png")
...
knitr::include_graphics("ch4_timeseries.png")
...
knitr::include_graphics("ch4_flowchart.png")
...
knitr::include_graphics("ch4_infoviz.jpg")
...
knitr::include_graphics("ch4_data.jpg")
...
knitr::include_graphics("ch4_sort-excel.jpg")
...
knitr::include_graphics("ch4_sort-sheets.jpg")
...
knitr::include_graphics("ch4_sort-excel.gif")
...
knitr::include_graphics("ch4_sort-sheets.gif")
...
knitr::include_graphics("ch4_sums-excel.gif")
...
knitr::include_graphics("ch4_sums-sheets.gif")
...
knitr::include_graphics("ch4_pivot-excel.gif")
...
knitr::include_graphics("ch4_pivot-sheets.gif")
...
knitr::include_graphics("ch4_pivot-excel2.gif")
...
knitr::include_graphics("ch4_pivot-sheets2.gif")
...
**Instructions:** Create multiple summary tables by sorting and using functions 
for the following:
...
**Challenges:** Complete the following challenges by creating summary tables with new functions.
...
**Advanced Challenge:** The following steps provide an advanced challenge.
...
**Advanced Question:** Which rappers are more diverse, on average?
...
directly within spreadsheets, right next to your **tabular data**, or your can 
...
knitr::include_graphics("ch4_chart-excel.gif")
...
knitr::include_graphics("ch4_chart-excel2.gif")
...
knitr::include_graphics("ch4_chart-sheets.gif")
...
knitr::include_graphics("ch4_chart-sheets2.gif")
...
knitr::include_graphics("ch4_chart-sheets3.gif")
...
knitr::include_graphics("ch4_format-excel.gif")
...
knitr::include_graphics("ch4_format-sheets.gif")
...
knitr::include_graphics("ch4_formatting-excel.gif")
...
Recreate the following visualization with the specifications below.

<br>

```{r fig.align = "center", out.width = "90%"}

knitr::include_graphics("ch4_exercise-excel.jpg")
...
These parameters will help you recreate the visualization exactly.
...
**Font Sizes:** 14 (Title), 11 (Axes Titles), 9 (Axes Labels), 8 (Source)

**Chart Title Font Color:** "Black, Text 1, Lighter 35%"

**Source Font Color:** "Black, Text 1, Lighter 50%"

<br>

##### Series

**Series Line Color:** "Blue, Accent 1"

**Series Line Width:** 1.5

<br>

##### Gridlines

**Gridline Color:** "White, Background 1, Darker 5%"

<br>

##### Labels

**Interval Between Labels:** 5
...
These tips are less precise than the above parameters but helpful to recreate techniques used.
...
knitr::include_graphics("ch4_exercise-sheets.png")
...
**Font Colors:** "Dark Gray 2" (Title), "Dark Gray 3" (Axes Titles), "Dark Gray 4" (Axes Labels)  

**Font Sizes:** 20 (Title), 14 (Axes Titles), 12 (Axes Labels)
...
**Title Font Color:** "Dark Gray 2"

**Axes Title Font Color:** "Dark Gray 3"
...
**Major Gridline Count:** 5

**Major Gridline Color:** "Light Gray 2"

<br>

##### Axes

**X-Axis Limits:** 1979 (Minimum), 2019 (Maximum)
...
knitr::include_graphics("ch4_charts-excel.jpg")
...
knitr::include_graphics("ch4_charts-sheets.jpg")
...
knitr::include_graphics("ch4_histogram.jpg")
...
knitr::include_graphics("ch5_scatterplot.jpg")
...
knitr::include_graphics("ch5_barchart.jpg")
...
knitr::include_graphics("ch5_timeseries.jpg")
...
knitr::include_graphics("ch5_datavizproject.gif")
...
knitr::include_graphics("ch5_continuous.jpg")
...
knitr::include_graphics("ch5_categorical.jpg")
...
knitr::include_graphics("ch5_multivariate.jpg")
...
As Eric B. and Rakim once chorused:
...
knitr::include_graphics("ch5_greens.gif")
...
knitr::include_graphics("ch5_brewer.gif")
...
knitr::include_graphics("ch5_coolers.gif")
...
knitr::include_graphics("ch5_colorpicker.gif")
...
knitr::include_graphics("ch5_contrastchecker.gif")
...
knitr::include_graphics("ch5_fonts.gif")
...
The purpose of our visualization is to depict the top 10 most influential hip 
hop tracks of all time, according to BBC Music (2020), and emphasize 
"The Message" by *Grandmaster Flash and the Furious Five* as the oldest track,
having been released in 1982.  We can imagine this in the context of a larger
exposition which describes the importance of "The Message" as formative to 
"Conscious Hip Hop", as a turning point when emcees began to outshine deejays, 
and its impact on hip hop today. 
...
knitr::include_graphics("ch5_fixes1.jpg")
...
knitr::include_graphics("ch5_fixes1.gif")
...
knitr::include_graphics("ch5_fixes2.jpg")
...
While that's incredible helpful in reducing the **noise** and increasing the 
...
knitr::include_graphics("ch5_fixes3.gif")
...
knitr::include_graphics("ch5_fixes3.jpg")
...
audience what its going to show them, it helps show them, and it helps in 
...
knitr::include_graphics("ch5_fixes4.gif")
...
knitr::include_graphics("ch5_fixes4.jpg")
...
knitr::include_graphics("ch5_fixes5.gif")
...
knitr::include_graphics("ch5_fixes5.jpg")
...
knitr::include_graphics("ch5_fixes6.gif")
...
knitr::include_graphics("ch5_fixes6.jpg")
...
knitr::include_graphics("ch5_fixes7.gif")
...
knitr::include_graphics("ch5_fixes7.jpg")
...
knitr::include_graphics("ch5_fixes8.gif")
...
knitr::include_graphics("ch5_fixes8.jpg")
...
knitr::include_graphics("ch5_eyemovement.jpg")
...
knitr::include_graphics("ch5_fixes9.gif")
...
knitr::include_graphics("ch5_eyemovement2.jpg")
...
knitr::include_graphics("ch5_fixes9.jpg")
...
*Notorious B.I.G.* was far more influential than the these other hip hop 
...
knitr::include_graphics("ch5_fixes10.gif")
...
knitr::include_graphics("ch5_fixes10.jpg")
...
knitr::include_graphics("ch5_fixes11.gif")
...
knitr::include_graphics("ch5_fixes11.jpg")
...
knitr::include_graphics("ch5_fixes12.gif")
...
knitr::include_graphics("ch5_fixes12.jpg")
...
Now it's your turn.  This exercise asks you to apply your new knowledge and 
techniques to declutter and polish an objectively terrible visualization 
(below).  Read the instructions and follow the steps provided below to do just 
that.

<br>
<br>

```{r fig.align = "center", out.width = "75%", dpi = 320}

knitr::include_graphics("ch5_practice.jpg")
...
Congratulations!  You've officially completed this workshop on applied 
